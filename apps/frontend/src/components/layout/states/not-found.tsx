...
export default function NotFound() {
	...
	return (
		<section className="flex flex-1 items-center justify-center px-6 py-16 font-brand">
			<Empty className="">
				<EmptyHeader className="gap-0">
					...
					<EmptyDescription className="max-w-sm text-gray-bright text-base tracking-tight">
        ...
        <EmptyContent className="max-w-2xs my-4 gap-2">
          <div className="w-full rounded-lg bg-secondary/80 flex items-center justify-center h-12 px-18">
          ...
          <div className="flex flex-col w-full">
            <Button
              ...
              nativeButton={false}
						  variant={"secondary"}
              className={"max-w-md rounded-lg h-12"}
            >
  					  Grab it!
  					</Button>
  					<Button
              ...
              size={'sm'}
  						nativeButton={false}
  						variant={"link"}
  						className={"rounded-lg text-gray-bright font-normal"}
  					>
  			      or back to home
  					</Button>
          </div>
